...
void APlayerCharacterController::MouseOn()
{
	if(bShowMouseCursor) bShowMouseCursor = false;
	else bShowMouseCursor = true;
	if(bEnableClickEvents)bEnableClickEvents = false;
	else bEnableClickEvents = true;
	if(bEnableMouseOverEvents)bEnableMouseOverEvents = false;
	else bEnableMouseOverEvents = true;
}
